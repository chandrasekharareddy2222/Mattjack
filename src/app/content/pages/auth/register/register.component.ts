...
export class RegisterComponent implements OnInit {
	...
	submit() {
		...
		var encoded = this.model.username + ":" + this.model.password;
		//console.log("encoded data"+JSON.stringify(encoded));
		let key = "access_token";
		//console.log("encoded data" + btoa(encoded));
		window.localStorage.setItem(key, encoded);
		//console.log("local storage " + btoa(window.localStorage.getItem(key)));

		this.authService.signUpService(data).subscribe(response => {
